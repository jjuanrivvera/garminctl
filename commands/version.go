...
const latestReleaseURL = "https://api.github.com/repos/jjuanrivvera/garminctl/releases/latest"

// reportLatest fetches the newest published release tag and tells the user whether they are up
// to date. It is best-effort: a network failure is reported, not fatal.
