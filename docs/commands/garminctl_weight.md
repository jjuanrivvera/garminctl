...
* [garminctl weight daily](garminctl_weight_daily.md)	 - Get weight data for a date
* [garminctl weight range](garminctl_weight_range.md)	 - Get weight data for a date range
