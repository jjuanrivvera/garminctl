## garminctl activities splits

Get activity splits

### Synopsis

Get splits/laps data for a specific activity including pace, heart rate, and elevation per lap

```
garminctl activities splits <activity_id> [flags]
```
