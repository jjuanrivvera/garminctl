...
* [garminctl devices list](garminctl_devices_list.md)	 - List all registered devices
* [garminctl devices settings](garminctl_devices_settings.md)	 - Get device settings
