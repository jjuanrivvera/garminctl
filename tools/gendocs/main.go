// Command gendocs generates the Markdown command reference under docs/commands from the live
// cobra tree, so the published docs never drift from the actual CLI surface.
package main
